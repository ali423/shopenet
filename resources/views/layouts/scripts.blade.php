...
<script>
    var url="https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?33847",s=document.createElement("script");s.type="text/javascript",s.async=!0,s.src=url;var options={enabled:!0,chatButtonSetting:{backgroundColor:"#4dc247",ctaText:"سوالی دارید ؟",borderRadius:"25",marginLeft:"0",marginBottom:"50",marginRight:"50",position:"left"},brandSetting:{brandName:"shopenet",brandSubTitle:"فروشگاه ساز آنلاین شاپی نت",brandImg:"https://shopenet.ir/images/logo/blacklogo.png",welcomeText:"سلام \n پشتیبانی شاپی نت آماده راهنمایی شماست ",messageText:"",backgroundColor:"#0a5f54",ctaText:"Start Chat",borderRadius:"25",autoShow:!1,phoneNumber:"989146955784"}};s.onload=function(){CreateWhatsappChatWidget(options)};var x=document.getElementsByTagName("script")[0];x.parentNode.insertBefore(s,x);
</script>
@yield('page_scripts')
